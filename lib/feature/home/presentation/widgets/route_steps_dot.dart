      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: isDone
                ? AppColors.success          // 🟢 أخضر لو عدّاها
                : isActive
                    ? AppColors.surface       // خلفية عادية، اللون بيبان من البوردر والنقطة
                    : AppColors.surfaceElevated,
            border: isActive
                ? Border.all(color: AppColors.info, width: 2)   // 🔵 أزرق بدل الأخضر
                : null,
          ),
          child: isDone
              ? const Icon(Icons.check, color: AppColors.whiteColor, size: 16)
              : isActive
                  ? Center(
                      child: Container(
                        ...
                        height: 10,
                        decoration: const BoxDecoration(
                          color: AppColors.info,       // 🔵 أزرق بدل الأخضر
                          shape: BoxShape.circle,
                        ),
                      ),
                    )
